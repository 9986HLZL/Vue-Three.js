...
exports.get = (req,res) => {
    var sql = 'select * from spareparts'
...
exports.add = (req,res) =>{          //向备品备件添加数据
    var sql = 'insert into spareparts (id,description,manufacturer,minimum,quantity,unit,price,executor) values(?,?,?,?,?,?,?,?)'
...
exports.update = (req,res) =>{          //通过id更新数据
    var sql = 'update spareparts set id=?,description=?,manufacturer=?,minimum=?,quantity=?,unit=?,price=?,executor=? where id=?'
...
exports.del = (req,res) =>{          //通过id删除数据
    var sql = 'delete from spareparts where id = ?'
