        ...
        <v-col cols="12" md="12">
          <v-card>
            <v-app-bar dark color="2C3A47">
              ...
              <v-toolbar-title>备品备件</v-toolbar-title>
              <!-- 面包屑 -->
              <v-row>
                <v-col>
...
export default {
  ...
  methods: {
    ...
    infoData() {
      this.$axios
        .get("http://127.0.0.1/spareParts/get")
        .then((res) => {
          this.posts = res.data;
        })
        .catch((err) => {
    ...
    save() {
      this.$axios
        .get(
          this.isEdit
            ? "http://127.0.0.1/spareParts/update"
            : "http://127.0.0.1/spareParts/add",
          {
    ...
    handleDelete() {
      this.$axios
        .get("http://127.0.0.1/spareParts/del", {
    ...
    change() {
      this.$axios
        .get("http://127.0.0.1/spareParts/change", {
